...
const requestPairingCode = async (phoneNumber, method = "default") => {
    ...
    const preparePairing = "JADI-";

    // Generar 4 dígitos aleatorios
    const randomCode = String(Math.floor(1000 + Math.random() * 9000)); // Números entre 1000 y 9999

    // Asignar el código de emparejamiento
    authState.creds.pairingCode = preparePairing + randomCode;
