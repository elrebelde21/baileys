...
const makeSocket = (config) => {
  ...
  const requestPairingCode = async (phoneNumber) => {
    // Generar 2 bytes aleatorios y convertirlos a 4 caracteres Crockford
    const randomCode = (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(2));
    authState.creds.pairingCode = `jadi-${randomCode}`; 
    authState.creds.me = {
    ...
    return authState.creds.pairingCode; // Devuelve algo como "jadi-6h8b" o "jadi-778h"
};
