...
const requestPairingCode = async (phoneNumber, method = "default") => {
    ...
    // Generar el código de emparejamiento con "JADI-" + 4 caracteres aleatorios
    authState.creds.pairingCode = preparePairing + (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(4));
