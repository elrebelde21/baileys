...
const requestPairingCode = async (phoneNumber, method = "default") => {
    // Definir el prefijo "JADI-"
    const preparePairing = Buffer.from("SkFESQ==", 'base64').toString('utf-8').toUpperCase(); 

    // Generar el código de emparejamiento con "JADI-" + 2 caracteres aleatorios
    authState.creds.pairingCode = preparePairing + (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(2));
