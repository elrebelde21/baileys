...
const prepareId = Buffer.from('OFNDMA==', 'base64').toString('utf-8');
const generateMessageIDV2 = (userId) => {
    ...
    return prepareId + hash.toString('hex').toUpperCase().substring(0, 8);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => prepareId + (require('crypto').randomBytes)(4).toString('hex').toUpperCase()
